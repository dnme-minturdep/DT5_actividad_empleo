...
Con este objetivo, se utilizará la [CIIU Rev. 4](https://unstats.un.org/unsd/publication/seriesm/seriesm_4rev4s.pdf) y la correspondiente delimitación de ramas características del turismo, tal como se explicita en la sección \@ref(ramas-características-del-turismo) del presente documento.
