...
```{r emit, echo=FALSE, fig.cap="Puestos de trabajo en RCT. Resultados preliminares de la CST-A." } 
  knitr::include_graphics('imagenes/figura2.2.jpg') 
```
