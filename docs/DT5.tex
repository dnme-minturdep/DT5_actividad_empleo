...
Con este objetivo, se utilizará la CIIU Revisión 4 \citep{ciiurev4} y la correspondiente delimitación de ramas características del turismo, tal como se explicita en la sección \ref{ramas-caracteristicas} del presente documento.
