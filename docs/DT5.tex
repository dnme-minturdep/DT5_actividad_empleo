...
\hypertarget{ramas-actividad}{%
\section{Ramas de Actividad Económica}\label{ramas-actividad}}
...
\caption{Cuentas de producción de las RCT, Argentina, 2004, 2016-2019. Resultados preliminares de la CST-A}\label{fig:cst}
\end{figure}
...
\caption{Puestos de trabajo en RCT. Resultados preliminares de la CST-A.}\label{fig:emit}
\end{figure}
...
Organización de las Naciones Unidas (2005): \emph{Clasificación Industrial Internacional Uniforme de todas las actividades económicas (CIIU), Revisión 3.1}, Nueva York, ONU, \textless{}\url{https://bit.ly/3jjYetv}\textgreater.
