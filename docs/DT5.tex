...
Con este objetivo, se utilizará la \href{https://unstats.un.org/unsd/publication/seriesm/seriesm_4rev4s.pdf}{CIIU Rev.~4} y la correspondiente delimitación de ramas características del turismo, tal como se explicita en la sección \ref{ramas-caracteristicas} del presente documento.
