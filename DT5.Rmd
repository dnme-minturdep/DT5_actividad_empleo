---
title: "Documento Técnico N°5: Medición de la contribución económica del turismo: actividad y empleo"
...
link-citations: yes
description: "Medición de la contribución económica del turismo: actividad y empleo"
---
...
La medición del impacto económico del turismo puede realizarse desde la perspectiva de la demanda[^1], la perspectiva de la oferta o bien desde la conciliación entre ambas perspectivas, lo que se ha definido como Cuenta Satélite de Turismo.
...
[^1]: Se puede consultar el capítulo 2 de @cstrmc2008

En cuanto a la perspectiva de la oferta[^2], la misma consiste en la medición de la producción realizada por todas aquellas industrias consideradas como características del turismo.
...
[^2]: Se puede consultar el capítulo 3 del [CST:RMC 2008](https://www.e-unwto.org/doi/book/10.18111/9789213612392), para más detalle sobre la metodología de esta perspectiva.
...
La serie de recomendaciones más actualizada puede encontrarse en el documento publicado por la OMT titulado "Cuenta satélite de turismo: Recomendaciones sobre el marco conceptual, 2008" ([CST:RMC 2008](https://www.e-unwto.org/doi/book/10.18111/9789213612392)).
...
Con el fin de realizar esta definición, se utilizará la Clasificación Industrial Internacional Uniforme (CIIU), cuya última versión disponible corresponde a la [revisión 4](https://unstats.un.org/unsd/publication/seriesm/seriesm_4rev4s.pdf), que constituye una estructura de clasificación coherente y consistente de las actividades económicas, basada en un conjunto de conceptos, definiciones, principios y normas de clasificación, de reconocimiento internacional.
...
Tomando como base la [CIIU Rev. 4](https://unstats.un.org/unsd/publication/seriesm/seriesm_4rev4s.pdf) (ONU, 2010), la Tabla 2 presenta las 21 categorías individuales de la CIIU.
...
### Ramas Características del Turismo
...
Según el párrafo 5.10 de las [RIET 2008](https://unstats.un.org/unsd/publication/seriesm/seriesm_83rev1s.pdf): "Los productos característicos del turismo son aquellos que cumplen uno o ambos de los siguientes criterios:
...
En conclusión, el manual [CST:RMC 2008](https://www.e-unwto.org/doi/book/10.18111/9789213612392) propone la consideración de 10 ramas (industrias) turísticas para la comparación internacional. Adicionalmente, se incorporan 2 líneas de industrias que pueden ser adicionadas por cada región si lo creyera pertinente, según el conocimiento de cómo se desarrolla el turismo dentro de sus límites geográficos. A continuación se presentan estas ramas con el detalle de cada código CIIU (Rev.4) asociado:
...
### Dificultades derivadas del nivel de desagregación de las ramas
...
## Medición de la oferta de las industrias turísticas
...
### Recomendaciones generales sobre la medición
...
### El caso particular de las agencias de viaje y los operadores turísticos
...
## Indicadores macroeconómicos por el lado de la oferta turística
...
### Valor Bruto de Producción de las Industrias Turísticas (VBPIT)
...
El Ministerio de Turismo y Deportes de la Nación realizó una estimación de la contribución económica del turismo en la Argentina con base en el año 2004[^4] y para los años 2016-2019, con la colaboración de la Dirección Nacional de Cuentas Nacionales (DNCN) del INDEC. 
...
[^4]: El año 2004, es el único año para el cual las cuentas nacionales de Argentina cuentan con Cuadros de Oferta-Utilización (COU). Estos cuadros consisten en un esquema estadístico, elaborado para el año 2004 por la Dirección de Cuentas Nacionales (DNCN) del INDEC, que cuenta con:
...
<!--chapter:end:01-medicion-actividad.Rmd-->
...
## Antecedentes internacionales de la medición del empleo en turismo
...
<!--chapter:end:02-medicion-empleo.Rmd-->
...
**El PGB, o PIB provincial, permite....**
...
<!--chapter:end:03-fuentes-informacion.Rmd-->
